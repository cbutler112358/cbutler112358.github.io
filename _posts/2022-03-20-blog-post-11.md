...
<p>
I have developed a nasty habit of using alliterative post titles. 
The letter <q>B</q> features prominently, although you must believe me when I say 
this is completely unintentional.
I will leave the more exciting story barred owl story to the end. For now, I want to talk about a wonderful 
puzzle I recently saw for the first time in years. The puzzle
...
the blue squares in the bottom left&#8212;blame R's funcky image function for this one). 
In the left sim, the grid is initialized with 10 infected squares. A small outbreak proceeds,
...
<p>
Taking these observations at face value, we have passed a threshold of some kind in 
the number of initial infected. The sims above give a few hints as to a solution to the problem. 
